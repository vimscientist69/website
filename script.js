...
function closeAllCards() {
  const allCards = document.querySelectorAll('.about-card, .socials-card, .contact-card');
...
const card1 = document.querySelectorAll('.about-card');
const card2 = document.querySelectorAll('.contact-card');
const card3= document.querySelectorAll('.socials-card');
